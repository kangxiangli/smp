<template lang="html">
	<div class="login_body">
		<el-row v-loading.fullscreen.lock="fullscreenLoading" :element-loading-text="$t('title.4')">
			<el-col :span="8" :offset="8">
				<div class="nav_logo">
					<img class="nav_logo_img" src="../../static/img/nav_logo.png" alt="" />
					<!--<div class="nav_logo_img"></div>-->
					<span class="nav_logo_span">{{$t("table.11")}}</span>
				</div>
				...
				<div class="login">
					<div class="login-form">
						<div class="card-block">
							...
							<h1>{{$t("table.12")}}</h1>
							<p class="text-muted">{{$t("table.13")}}</p>

							<div class="input-group m-b-1">
								<span class="input-group-addon"><i class="fa fa-user"></i></span>
								<input type="text" class="form-control" placeholder="Username" v-model="form.floginName">
							</div>
							<div class="input-group m-b-2">
								<span class="input-group-addon"><i class="fa fa-lock"></i></span>
								<input type="password" class="form-control" placeholder="Password" v-model="form.fpassword" @keyup.enter="login">
							</div>
							...
							<div class="row">
								<el-row>
									<el-col :span="12" style="width: 100%;text-align: center;">
										<el-button type="primary" class="btn login_btn_box btn-primary p-x-2" @click="login">{{$t("table.14")}}</el-button>
									</el-col>
